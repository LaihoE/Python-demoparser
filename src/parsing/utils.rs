...
pub static TYPEHM: phf::Map<&'static str, i32> = phf_map! {
    "manager_m_iMatchStats_EnemiesFlashed_Total" => 0,
    "manager_m_iKills" => 0,
    "manager_m_iDeaths" => 0,
    "rules_DT_CSGameRules.m_bWarmupPeriod" => 0,
    "rules_DT_CSGameRules.m_fMatchStartTime" => 1,
    "rules_DT_CSGameRules.m_fWarmupPeriodEnd" => 1,
    "rules_m_flNextRespawnWave" => 1,
    "rules_m_iMatchStats_RoundResults" => 0,
    "manager_m_iMVPs" => 0,
    "manager_m_iPing" => 0,
    "manager_m_iCompetitiveWins" => 0,
    "manager_m_iPing.004" => 0,
    "player_m_vecOrigin_X" => 1,
    "player_m_vecOrigin_Y" => 1,
